...
public class NodeInitializer{
	...
	private void choosePieces(int percentage, BitTorrent p){
		...
		//System.out.println("completed="+completed+" percentage="+percentage);
